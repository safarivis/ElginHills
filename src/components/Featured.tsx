...
const Featured = () => {
  const wines = [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1558732381-f1e0c9c1e5ec?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1000&q=80",
